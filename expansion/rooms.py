...
DEFAULT_ROOMS = (
    ...
    RoomPage(ROOM_SCHEMA_VERSION, 'dossiers', 'Dossiers', '/dossiers',
             'ledger', 'DOS', 'Canonical + living dossiers with vulnerability depth and WHY.',
             shared=True, kind='shared_surface', health_source='journal'),
    RoomPage(ROOM_SCHEMA_VERSION, 'journal', 'Journal', '/journal',
             'ledger', 'JNL', 'Objective chronological history — what happened.',
             shared=True, kind='shared_surface', health_source='journal'),
    RoomPage(ROOM_SCHEMA_VERSION, 'diary', 'Diary', '/diary',
             'ledger', 'DRY', 'Subjective interpretation — what it meant.',
             shared=True, kind='shared_surface', health_source='journal'),
    RoomPage(ROOM_SCHEMA_VERSION, 'relationships', 'Relationships', '/relationships',
             'aria', 'REL', 'Directional multi-dimension relationship matrix.',
             shared=True, kind='shared_surface', health_source='readiness'),
    RoomPage(ROOM_SCHEMA_VERSION, 'emotions', 'Emotions', '/emotions',
             'aria', 'EMO', 'Emotional state floor with baseline, decay, and WHY.',
             shared=True, kind='shared_surface', health_source='readiness'),
