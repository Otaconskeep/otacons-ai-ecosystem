...
TTS_ACTIONS=[('CHECK_TTS_RUNTIME','Checking voice service'),('INSTALL_TTS_RUNTIME','Installing voice service'),('CHECK_VOICE','Checking voice'),('DOWNLOAD_VOICE','Downloading voice'),('REGISTER_TTS_SERVICE','Registering voice service'),('VALIDATE_TTS_SERVICE','Validating voice service'),('VALIDATE_VOICE_PROFILE','Validating voice profile'),('SYNTHESIZE_TEST_AUDIO','Testing speech'),('ASSIGN_AGENT_VOICE','Assigning agent voice')]
